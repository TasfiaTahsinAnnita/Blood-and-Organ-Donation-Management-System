...
<div id="content" >
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <?php
// Start PHP session and include your database connection file
include 'conn.php'; // Include your database connection file here
...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
    ...
    // Provide some response to the user
...
<script>
    function clickme() {
        if (confirm("Do you really Want to Read ?")) {
            ...
            // Assuming you want to redirect after the confirmation
            window.location.href = "http://localhost/BDMS/admin/query.php"; // Replace "your_page.php" with your actual page URL
        }
    }
</script>
...
<td id="he" style="width:100px">
    <button style="background-color:aqua" onclick="deleteQuery(<?php echo $row['query_id']; ?>)">Delete</button>
</td>
